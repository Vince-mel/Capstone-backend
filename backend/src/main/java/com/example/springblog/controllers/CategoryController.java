...
public class CategoryController {
    ...
    //    Api crea nuova categoria (ricordarsi di gestirla in react tramite le route
    @PostMapping("/")
    ...
    @GetMapping("/")
    public ResponseEntity<List<CategoryDto>> getAllCategoryByCategoryId() {
